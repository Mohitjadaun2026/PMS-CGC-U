          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  onClick={() => setActiveTab('create')}
                  className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-6 py-3 rounded-2xl font-semibold hover:scale-105 transform transition-all duration-200 shadow-lg flex items-center gap-2 cursor-pointer"
                >
                      ...
                      <div className="flex items-start justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-2 bg-gray-800/50 hover:bg-yellow-400/20 border border-gray-700/50 hover:border-yellow-400/50 rounded-xl transition-all duration-200 text-gray-400 hover:text-yellow-400 cursor-pointer"
                          >
                            <Edit3 className="w-4 h-4" />
                          </button>
                          <button
                            onClick={() => handleDelete(job._id)}
                            className="p-2 bg-gray-800/50 hover:bg-red-400/20 border border-gray-700/50 hover:border-red-400/50 rounded-xl transition-all duration-200 text-gray-400 hover:text-red-400 cursor-pointer"
                          >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              <button
                ...
                className="p-3 bg-gray-900/50 hover:bg-gray-800/50 border border-gray-700/50 cursor-pointer rounded-2xl transition-all duration-200 text-gray-400 hover:text-white"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex items-center justify-between pt-8 border-t border-gray-800/50">
                <button
                  type="button"
                  onClick={handleCancel}
                  className="px-8 py-4 cursor-pointer bg-gray-800/50 hover:bg-gray-700/50 border border-gray-700/50 hover:border-gray-600/50 rounded-2xl text-gray-300 hover:text-white font-semibold transition-all duration-200 flex items-center gap-2"
                >
                  <X className="w-5 h-5" />
                  Cancel
                </button>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-yellow-400 to-yellow-500 cursor-pointer text-black px-8 py-4 rounded-2xl font-bold hover:scale-105 transform transition-all duration-200 shadow-xl flex items-center gap-2"
                  >
